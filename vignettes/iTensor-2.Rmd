...
out_groupica_pooled_infomax <- GroupICA(data2, J1=6, algorithm="pooled", ica.algorithm="InfoMax")

out_groupica_Calhoun2009_fastica <- GroupICA(data2, J1=6, algorithm="Calhoun2009", ica.algorithm="FastICA")

out_groupica_Pfister2018_amuse <- GroupICA(data2, J1=6, algorithm="Pfister2018", ica.algorithm="AMUSE")
```
