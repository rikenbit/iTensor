...
Here we use CorrIndex, which is a performance index to evaluate ICA results [@corrindex]. CorrIndex imply that FastICA, ExtInfoMax, JADE, and SIMBEC performed well (the closer to 0, the better the performance).
...
pairs(out1$out.AuxICA1$S, main="AuxICA1")
pairs(out1$out.AuxICA2$S, main="AuxICA2")
pairs(out1$out.SIMBEC$S, main="SIMBEC")
pairs(out1$out.AMUSE$S, main="AMUSE")
pairs(out1$out.SOBI$S, main="SOBI")
pairs(out1$out.FOBI$S, main="FOBI")
pairs(out1$out.ProDenICA$S, main="ProDenICA")
pairs(out1$out.RICA$S, main="RICA")
```
...
CorrIndex imply that FastICA, InfoMax, ExtInfoMax, JADE, AuxICA1, and AuxICA2 performed well.
...
pairs(out2$out.AuxICA1$S, main="AuxICA1")
pairs(out2$out.AuxICA2$S, main="AuxICA2")
pairs(out2$out.SIMBEC$S, main="SIMBEC")
pairs(out2$out.AMUSE$S, main="AMUSE")
pairs(out2$out.SOBI$S, main="SOBI")
pairs(out2$out.FOBI$S, main="FOBI")
pairs(out2$out.ProDenICA$S, main="ProDenICA")
pairs(out2$out.RICA$S, main="RICA")
```
...
pairs(out3$out.AuxICA1$S, main="AuxICA1")
pairs(out3$out.AuxICA2$S, main="AuxICA2")
pairs(out3$out.SIMBEC$S, main="SIMBEC")
pairs(out3$out.AMUSE$S, main="AMUSE")
pairs(out3$out.SOBI$S, main="SOBI")
pairs(out3$out.FOBI$S, main="FOBI")
pairs(out3$out.ProDenICA$S, main="ProDenICA")
pairs(out3$out.RICA$S, main="RICA")
```
...
CorrIndex imply that FastICA, ExtInfoMax, JADE, AMUSE, ProDenICA performed well.
...
pairs(out4$out.AuxICA1$S, main="AuxICA1")
pairs(out4$out.AuxICA2$S, main="AuxICA2")
pairs(out4$out.SIMBEC$S, main="SIMBEC")
pairs(out4$out.AMUSE$S, main="AMUSE")
pairs(out4$out.SOBI$S, main="SOBI")
pairs(out4$out.FOBI$S, main="FOBI")
pairs(out4$out.ProDenICA$S, main="ProDenICA")
pairs(out4$out.RICA$S, main="RICA")
```
